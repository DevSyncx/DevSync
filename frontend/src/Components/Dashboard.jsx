  ...
  useEffect(() => {
    ...
    if (urlToken) {
      ...
      try {
        ...
        // Also store in sessionStorage for GitHub API calls
    ...
    const fetchProfile = async () => {
      try {
        ...
        const res = await fetch(`${import.meta.env.VITE_API_URL}/api/profile`, requestOptions);
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 bg-[#d1e4f3]">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
            {/* Row 1: ProfileCard, PlatformLinks, StreakCard */}
