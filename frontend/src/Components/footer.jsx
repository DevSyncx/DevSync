...
const Footer = () => {
  return (
    <footer
      className="rounded-lg mt-32 pt-24 pb-10 px-6 md:px-12"
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          <h3
            className="text-3xl font-bold mb-2 tracking-tight cursor-pointer transition-all duration-300 hover:scale-105 hover:text-blue-400"
        ...
        <div>
          ...
          >
            ...
            <a href="mailto:hello@devsync.com" className="hover:text-blue-400">
      ...
      >
        ...
        <p>
          Made with ☕ by{" "}
          <span className="font-semibold text-[var(--primary)]">Annanya</span>
        </p>
      </div>
    </footer>
  );
