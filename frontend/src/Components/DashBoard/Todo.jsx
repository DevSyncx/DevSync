      ...
      <div className="flex items-start justify-between">
        <div className="flex items-start gap-3">
          <button
            ...
            className="mt-1 p-1 rounded-full hover:bg-[var(--accent)]"
      ...
      <main className="flex-1 p-6 bg-[#d1e4f3]">
        <div className="max-w-full mx-auto space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-[var(--card-foreground)] dark:text-[var(--primary)]">
              To-Do List
            </h2>
            <div className="flex items-center gap-2 ml-auto">
              <div className="relative">
                <select
                  ...
                  className="appearance-none pr-8 pl-3 py-2 rounded-lg bg-[var(--card)] text-[var(--card-foreground)] border border-[var(--input)]"
                >
              ...
              <div className="w-full max-w-lg p-5 rounded-xl bg-[var(--card)] border border-[var(--border)] shadow-xl">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-2 py-1 rounded-md hover:bg-[var(--accent)] text-[var(--card-foreground)]"
                  >
                    ✕
                  </button>
                </div>
                ...
                >
                  <input
                    ...
                    placeholder="Title"
                    className="px-3 py-2 rounded-lg bg-[var(--background)] text-[var(--card-foreground)] border border-[var(--input)]"
                  />
                  <textarea
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setModalData({ ...modalData, deadline: e.target.value })
                      }
                      className="px-3 py-2 rounded-lg bg-[var(--background)] text-[var(--card-foreground)] border border-[var(--input)]"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-end gap-2 mt-2">
                    <button
                      ...
                      className="px-4 py-2 rounded-lg border border-[var(--input)] text-[var(--card-foreground)] hover:bg-[var(--accent)]"
                    >
                      Cancel
                    </button>
                    <button
