...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create a mock token
      const mockToken = "test_mock_token_" + Date.now();
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button 
                ...
                onClick={() => {
                  alert("GitHub authentication requires valid GitHub OAuth credentials. Please use the regular login form for now.");
                }}
              >
